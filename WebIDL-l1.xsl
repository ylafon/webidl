<xsl:stylesheet xmlns:xsl='http://www.w3.org/1999/XSL/Transform'
  ...
  <xsl:template match='h:head'>
      ...
      <xsl:apply-templates select='node()'/>
        ...
        <script class="remove" type="application/ecmascript">
            ...
            localBiblio: {
                ...
                "IEEE-754" : {
                    "hrefold" : "http://ieeexplore.ieee.org/xpl/articleDetails.jsp?arnumber=30711",
    ...
    <!--        wgPublicList: '<xsl:value-of select="$options/x:participate/x:mailing-list/@email" />',-->
            ...
            href: 'https://github.com/w3c/webidl'
            }, {
            value: 'File a bug.',
            href: 'https://github.com/w3c/webidl/issues'
            }, {
            value: 'Commit history.',
            href: 'https://github.com/w3c/webidl/commits/gh-pages'
            }, {
            value: 'Mailing list.',
